...
namespace App\Core\Infrastructure\Symfony\DependencyInjection\Compiler;

use App\Core\Infrastructure\Persistence\Doctrine\Types\DoctrineCustomTypeInterface;
use Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use Symfony\Component\DependencyInjection\ContainerBuilder;

final class AutoConfigureDoctrineTypesPass implements CompilerPassInterface
{
    private const DOCTRINE_TYPES_PARAM = 'doctrine.dbal.connection_factory.types';
    private const CUSTOM_TYPE_TAG = 'doctrine.custom_type';

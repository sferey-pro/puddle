...
use App\Module\UserManagement\Application\DTO\ChangeEmailAddressDTO;
 ...
 */
final readonly class ChangeUserEmailAddress implements CommandInterface
{
    public function __construct(
        public UserId $userId,
        public ChangeEmailAddressDTO $dto,
    ) {
    }
}

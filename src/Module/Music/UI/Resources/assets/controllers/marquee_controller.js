...
export default class extends Controller {
    ...
    updateMarquee() {
        if (!this.hasAnchorTarget) {
            console.error("Marquee Controller: L'élément <a> avec data-marquee-target='anchor' est introuvable.");
            return;
        }
        ...
        if (shouldScroll) {
            ...
            const currentSpeed = (this.hasSpeedValue && this.speedValue > 0) ? this.speedValue : this.constructor.values.speed.default;
            ...
            anchorElement.style.setProperty('--text-segment-width', `${textWidthWithPadding}px`);

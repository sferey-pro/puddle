...
/**
 * Classe de type Doctrine pour le ValueObject LoginLinkId.
 * Permet à Doctrine de comprendre comment stocker et récupérer cet objet.
 */
final class LoginLinkIdType extends AbstractValueObjectIdType
{
    /**
     * Le nom unique de notre type pour Doctrine.
     */
    public const NAME = 'login_link_id';

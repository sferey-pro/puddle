...
/**
 * Classe de type Doctrine pour le ValueObject PasswordCredentialId.
 * Permet à Doctrine de comprendre comment stocker et récupérer cet objet.
 */
final class PasswordCredentialIdType extends AbstractValueObjectIdType
{
    /**
     * Le nom unique de notre type pour Doctrine.
     */
    public const NAME = 'password_credential_id';
    ...
    {
        return PasswordCredentialId::class;
    }

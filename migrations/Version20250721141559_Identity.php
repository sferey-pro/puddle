...
final class Version20250721141559_Identity extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX idx_identifier_user ON identity_attached_identifiers (user_id)');
        $this->addSql('CREATE INDEX idx_identifier_verified ON identity_attached_identifiers (is_verified, identifier_type)');
        $this->addSql('CREATE INDEX idx_identifier_primary ON identity_attached_identifiers (user_id, is_primary)');
        $this->addSql('CREATE INDEX idx_identifier_type ON identity_attached_identifiers (identifier_type)');
        $this->addSql('CREATE INDEX idx_identifier_complex ON identity_attached_identifiers (identifier_type, is_verified, is_primary)');
        ...
        $this->addSql('CREATE INDEX idx_user_identity_user_id ON identity_user_identities (user_id)');
        $this->addSql('CREATE INDEX idx_user_identity_created ON identity_user_identities (created_at)');

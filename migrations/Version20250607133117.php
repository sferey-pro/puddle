 ...
 */
final class Version20250607133117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE cost_item (description TEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, id UUID NOT NULL, name VARCHAR(255) NOT NULL, target_amount INT NOT NULL, target_currency VARCHAR(3) NOT NULL, current_amount INT NOT NULL, current_currency VARCHAR(3) NOT NULL, coverage_start_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, coverage_end_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'

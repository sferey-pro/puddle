...
final class Version20250721141502_Account extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX idx_account_state ON "accounts" (state_name)');
        $this->addSql('CREATE INDEX idx_account_deleted ON "accounts" (deleted_at)');
        $this->addSql('CREATE INDEX idx_account_state_created ON "accounts" (state_name, created_at)');
        $this->addSql('CREATE INDEX idx_account_verified ON "accounts" (verified_at)');
        $this->addSql('CREATE INDEX idx_account_state_active ON "accounts" (state_is_active)');
        $this->addSql('CREATE INDEX idx_account_state_expires ON "accounts" (state_expires_at)');

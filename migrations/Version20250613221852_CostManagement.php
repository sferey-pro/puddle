...
final class Version20250613221852_CostManagement extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE cost_contribution (source_product_id UUID NOT NULL, status VARCHAR(255) NOT NULL, contributed_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, id UUID NOT NULL, amount INT NOT NULL, currency VARCHAR(3) NOT NULL, cost_item_id UUID NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'

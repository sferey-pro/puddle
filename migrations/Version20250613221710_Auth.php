...
final class Version20250613221710_Auth extends AbstractMigration
{
        ...
        public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE user_accounts (id UUID NOT NULL, roles JSON NOT NULL, is_verified BOOLEAN NOT NULL, is_active BOOLEAN NOT NULL,  password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'

...
export default class extends Controller {
  ...
  timeLeftValueChanged(value) {
    if(this.hasCallbackTarget && value <= 0) {
      const otherController = this.application.getControllerForElementAndIdentifier(this.callbackTarget, this.callbackIdentifierValue)
